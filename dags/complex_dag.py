...
task7 = BashOperator(task_id='tsk7', bash_command='sleep 3', dag=dag)
task8 = BashOperator(task_id='tsk8', bash_command='sleep 3', dag=dag)
task9 = BashOperator(task_id='tsk9', bash_command='sleep 5', trigger_rule='one_failed', dag=dag)
